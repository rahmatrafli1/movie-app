<section class="container mx-auto p-6 font-mono">
    ...
    <x-dialog-modal wire:model.live="showSeasonModal">
                ...
                <div class="mt-10 sm:mt-0">
                    <div class="mt-5 md:mt-0 md:col-span-2">
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2">
                                <input wire:model="seasonName" type="text" id="name" autocomplete="off"
                        ...
                        <div class="sm:col-span-3">
                            <label for="season_number" class="block text-sm font-medium leading-6 text-gray-900">Season
                                Number</label>
                            <div class="mt-2">
                                <input wire:model="seasonNumber" type="text" id="season_number" autocomplete="off"
                                    class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                            </div>
                            @error('seasonNumber')
                                <span class="text-red-600 text-sm">{{ $message }}</span>
